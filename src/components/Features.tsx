...
const features = [
  {
    ...
    visual: "calendar",
    screenshot: "https://postiz.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FTool-Planning.3f9ff858.png&w=1920&q=75",
  },
  {
    ...
    span: "col-span-1",
    visual: "ai",
    screenshot: "https://postiz.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FTool-Creating.f4022706.png&w=1080&q=75",
  },
  {
    ...
    span: "col-span-1",
    visual: "analytics",
    screenshot: "https://postiz.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FTool-Analytics.d1755132.png&w=1920&q=75",
  },
  {
    ...
    span: "col-span-1",
    visual: "team",
    screenshot: "https://postiz.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FTool-Organizing.bae04955.png&w=1080&q=75",
  },
  {
  ...
  },
  {
    ...
    visual: "api",
    screenshot: "https://postiz.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fpost-web.69922432.png&w=1920&q=75",
  },
];
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {features.map((feature, i) => (
            ...
            >
              ...
              {feature.screenshot ? (
                <ScreenshotVisual src={feature.screenshot} alt={feature.title} />
              ) : (
                <DockerVisual />
              )}
            </motion.div>
